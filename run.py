...
import argparse
import logging
from models.dataset import BRCDataset
from models.vocab import Vocab
from models.rc_model import RCModel
from rc_demo import Demo
...
def parse_args():
    ...
    parser.add_argument('--demo', action='store_true', help='rc demo')
    ...
    train_settings.add_argument('--epochs', type=int, default=1000,
                                help='train epochs')
    ...
    model_settings.add_argument('--max_char_num', type=int, default=5,
                                help='max num of char of term')

    path_settings = parser.add_argument_group('path settings')
    path_settings.add_argument('--train_files', nargs='+',
                               default=['data/demo/trainset/search.train.json',
                               'data/demo/trainset/zhidao.train.json'],
                               help='list of files that contain the demo train data')
    path_settings.add_argument('--dev_files', nargs='+',
                               default=['data/demo/devset/search.dev.json',
                               'data/demo/devset/zhidao.dev.json'],
                               help='list of files that contain the demo dev data')
    path_settings.add_argument('--test_files', nargs='+',
                               default=['data/demo/testset/search.test.json',
                               'data/demo/testset/search.test.json'],
                               help='list of files that contain the demo test data')
    path_settings.add_argument('--brc_dir', default='data/baidu',
                               help='the dir with demo baidu reading comprehension data')
